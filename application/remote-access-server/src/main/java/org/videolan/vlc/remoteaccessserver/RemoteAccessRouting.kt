...
fun Route.setupRouting(appContext: Context, scope: CoroutineScope) {
    ...
    get("/translation") {
        call.respondJson(convertToJson(TranslationMapping.generateTranslations(appContext.getContextWithLocale(org.videolan.resources.AppContextProvider.locale))))
    }
    get("/secure-url") {
