                        ...
                        mediaMetadataWithImages.metadata.mlId?.let { mlId ->
                            ...
                            matrixCursor.addRow(
                                arrayOf(
                                    media.id,
                                    "media_${media.id}",
                                    mediaMetadataWithImages.metadata.title,
                                    mediaMetadataWithImages.subtitle(),
                                    thumbnail,
                                    mediaMetadataWithImages.metadata.getYear(),
                                    media.length
                                )
                            )
                        }
                            ?: if (mediaMetadataWithImages.metadata.type == MediaMetadataType.TV_SHOW) {
                                ...
                                val mediaMetadataEpisodes =
                                    mediaMetadataRepository.getTvShowEpisodes(mediaMetadataWithImages.metadata.moviepediaId)
                                ...
                                provider.getFirstResumableEpisode(medialibrary, mediaMetadataEpisodes)?.let { firstResumableEpisode ->
                                    ...
                                    matrixCursor.addRow(
                                        arrayOf(
                                            media.id,
                                            "${CONTENT_RESUME}${mediaMetadataWithImages.metadata.moviepediaId}",
                                            mediaMetadataWithImages.metadata.title,
                                            context.getString(R.string.resume_episode, firstResumableEpisode.tvEpisodeSubtitle()),
                                            thumbnail,
                                            firstResumableEpisode.metadata.getYear(),
                                            media.length
                                        )
                                    )
                                }
                                ...
                                mediaMetadataEpisodes.forEach { mediaMetadataWithImages ->
                                    mediaMetadataWithImages.metadata.mlId?.let { mlId ->
                                        ...
                                        matrixCursor.addRow(
                                            arrayOf(
                                                media.id,
                                                "${CONTENT_EPISODE}${mediaMetadataWithImages.metadata.moviepediaId}",
                                                mediaMetadataWithImages.metadata.title,
                                                mediaMetadataWithImages.subtitle(),
                                                thumbnail,
                                                mediaMetadataWithImages.metadata.getYear(),
