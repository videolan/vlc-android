...
class WebserverOnboardingOtpFragment : WebserverOnboardingFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.webserver_onboarding_otp, container, false)
    }
        ...
        animSet.doOnEnd {
            lifecycleScope.launch {
                viewLifecycleOwner.repeatOnLifecycle(Lifecycle.State.STARTED) {
                    ...
                    access.setImageDrawable(ContextCompat.getDrawable(requireActivity(), if (iteration % 2 == 0) R.drawable.ic_webserver_onboarding_verified else R.drawable.ic_webserver_onboarding_denied))
    ...
    companion object {
        fun newInstance(): WebserverOnboardingOtpFragment {
            return WebserverOnboardingOtpFragment()
        }
    }
}