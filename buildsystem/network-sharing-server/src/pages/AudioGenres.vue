<template>
    <div v-if="loaded && this.genres.length !== 0" class="container">
        ...
        <div v-else class="row gx-3 gy-3 media-content">
            <div class="col-md-3 col-lg-2 col-sm-4 col-6" v-for="genre in genres" :key="genre.id">
                <MediaItem :isCard="true" :media="genre" :mediaType="'genre'" />
            </div>
        </div>
    </div>
