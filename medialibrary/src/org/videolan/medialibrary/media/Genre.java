...
public class Genre extends AbstractGenre {
    ...
    private native MediaWrapper[] nativeGetTracks(AbstractMedialibrary ml, long mId, boolean withThumbnail, int sort, boolean desc);
    ...
    private native MediaWrapper[] nativeGetPagedTracks(AbstractMedialibrary ml, long mId, boolean withThumbnail, int sort, boolean desc, int nbItems, int offset);
